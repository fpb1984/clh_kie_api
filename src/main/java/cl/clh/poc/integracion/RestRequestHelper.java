...
public class RestRequestHelper extends RemoteConfiguration {
     ...
     */
    public RestRequestHelper(String serverPortUrl, String username, String password, int timeout) throws MalformedURLException {
        super();
        this.requestFactory = createAuthenticatingRequestFactory(new URL(serverPortUrl + "rest/"), username, password, timeout);
    }
     ...
     * 
     */
    public RestRequestHelper(String serverPortUrl, String username, String password) throws MalformedURLException {
        super();
        if (!serverPortUrl.endsWith("/")) {
            serverPortUrl = serverPortUrl + "/";
        }
        this.requestFactory = createAuthenticatingRequestFactory(new URL(serverPortUrl + "rest/"), username, password, DEFAULT_TIMEOUT);
    }
     ...
     * @throws MalformedURLException 
     */
    public static ClientRequestFactory createRestRequest(String restBaseUrl, String username, String password, int timeout) throws MalformedURLException {
        return createAuthenticatingRequestFactory(new URL(restBaseUrl), username, password, timeout);
    }
     ...
     * @throws MalformedURLException 
     */
    public static ClientRequestFactory createRestRequest(String restBaseUrl, String username, String password) throws MalformedURLException {
        return createAuthenticatingRequestFactory(new URL(restBaseUrl), username, password, DEFAULT_TIMEOUT);
    }
